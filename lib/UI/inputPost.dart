...
class _InputPostState extends State<InputPost> {
  ...
  void initState() {
    ...
    if (widget.post.id != 0) {
      id = widget.post.id;
      judul = TextEditingController(text: widget.post.nama_property);
      // category = TextEditingController(text: widget.post.category);
      user = TextEditingController(text: widget.post.tipe_property);
      deskripsi = TextEditingController(text: widget.post.harga);
  ...
  void submit() async {
    if (_formkey.currentState!.validate()) {
      ...
      var params = {
        'Nama Property': judul.text.toString(),
        'Tipe Property': user.text.toString(),
        'Harga': deskripsi.text.toString(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: _isupdate
            ? Text('Update ' + widget.post.nama_property)
            : Text('Input Property'),
      ),
